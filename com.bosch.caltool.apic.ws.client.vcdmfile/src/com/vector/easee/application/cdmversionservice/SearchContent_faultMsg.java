...
public class SearchContent_faultMsg extends java.lang.Exception{
    ...
    private com.vector.easee.application.cdmversionservice.CDMVersionServiceStub.ErrorType faultMessage;
        ...
        public SearchContent_faultMsg() {
            super("SearchContent_faultMsg");
        }

        public SearchContent_faultMsg(java.lang.String s) {
           super(s);
        }

        public SearchContent_faultMsg(java.lang.String s, java.lang.Throwable ex) {
          super(s, ex);
        }

        public SearchContent_faultMsg(java.lang.Throwable cause) {
            super(cause);
        }
