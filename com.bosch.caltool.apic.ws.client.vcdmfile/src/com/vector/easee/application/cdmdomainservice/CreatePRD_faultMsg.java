...
public class CreatePRD_faultMsg extends java.lang.Exception{

    private static final long serialVersionUID = 1402376928848L;
    
    private com.vector.easee.application.cdmdomainservice.CDMDomainServiceStub.ErrorType faultMessage;

    
        public CreatePRD_faultMsg() {
            super("CreatePRD_faultMsg");
        }

        public CreatePRD_faultMsg(java.lang.String s) {
           super(s);
        }

        public CreatePRD_faultMsg(java.lang.String s, java.lang.Throwable ex) {
          super(s, ex);
        }

        public CreatePRD_faultMsg(java.lang.Throwable cause) {
            super(cause);
        }
