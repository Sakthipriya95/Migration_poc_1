...
public class DeleteObjectFault extends java.lang.Exception{

    private static final long serialVersionUID = 1401773392011L;
    
    private com.vector.easee.application.cdmversionservice.CDMVersionServiceStub.ErrorType faultMessage;

    
        public DeleteObjectFault() {
            super("DeleteObjectFault");
        }

        public DeleteObjectFault(java.lang.String s) {
           super(s);
        }

        public DeleteObjectFault(java.lang.String s, java.lang.Throwable ex) {
          super(s, ex);
        }

        public DeleteObjectFault(java.lang.Throwable cause) {
            super(cause);
        }
