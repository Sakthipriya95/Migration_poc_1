 ...
 * @author mkl2cob
 */
public class DaCompHexToolbarActionSet {

  private final CustomFilterGridLayer<DaCompareHexParam> compRprtFilterGridLayer;

  private final DataAssessmentCompHexRvwResultsPage page;

  /**
   * @param compRprtFilterGridLayer CustomFilterGridLayer<DaCompareHexParam>
   * @param page DataAssessmentCompHexRvwResultsPage
   */
  public DaCompHexToolbarActionSet(final CustomFilterGridLayer<DaCompareHexParam> compRprtFilterGridLayer,
      final DataAssessmentCompHexRvwResultsPage page) {
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void showMatchLatestFuncVer(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
    final Action latestFunAction =
        new Action("Parameter with Function Version equal to latest Review Function Version", SWT.TOGGLE) {
          ...
          public void run() {
            ...
            DaCompHexToolbarActionSet.this.compRprtFilterGridLayer.getFilterStrategy()
                .applyToolBarFilterInAllColumns(false);
            DaCompHexToolbarActionSet.this.compRprtFilterGridLayer.getSortableColumnHeaderLayer()
                .fireLayerEvent(new FilterAppliedEvent(
                    DaCompHexToolbarActionSet.this.compRprtFilterGridLayer.getSortableColumnHeaderLayer()));
            DaCompHexToolbarActionSet.this.page.getNatTable().redraw();
          }
        };
  ...
  public void showNotMatchLatestFuncVer(final ToolBarManager toolBarManager,
      final DaCompHexToolBarFilter toolBarFilters) {
   ...
   */
  public void complianceFilterAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
   ...
   */
  public void showCompli(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
   ...
   * @param toolBarFilters ReviewResultToolBarFilters
   */
  public final void showOk(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
  ...
  */
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void showReadOnlyAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void showNotReadOnlyAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void qSSDFilterAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void nonQSSDFilterAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
   ...
   */
  public void blackListFilterAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters,
   ...
   * @param natTable CustomNATTable
   */
  public void nonBlackListFilterAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters,
      final CustomNATTable natTable) {
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void dependantCharAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void noDependantCharAction(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void showWpFinished(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
    ...
    wpFinished.setImageDescriptor(ImageManager.getImageDescriptor(
   ...
   * @param toolBarFilters DaCompHexToolBarFilter
   */
  public void showWpNotFinished(final ToolBarManager toolBarManager, final DaCompHexToolBarFilter toolBarFilters) {
    ...
    wpNotFinished.setImageDescriptor(ImageManager.getImageDescriptor(
