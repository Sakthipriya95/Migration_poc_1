...
/**
 * ICDM-1764 Editor to display review results
 *
 * @author mkl2cob
 */
public class ReviewListEditor extends AbstractFormEditor {

  /**
   * PIDCRvwResultsDtlsPage page instance
   */
  private ReviewListPage pidcRvwResDtlsPage;
  /**
   * Defines PIDCEditor id
   */
  public static final String EDITOR_ID = "com.bosch.caltool.cdr.ui.editors.ReviewListEditor";
  ...
  protected void addPages() {
    try {
      // PIDCRvwResultsDtlsPage instance is added to the pages of editor
      this.pidcRvwResDtlsPage = new ReviewListPage(this, "", "Review Results");
      addPage(this.pidcRvwResDtlsPage);
      // ICDM-2177
      setPartName("Review Results : " + ((ReviewListEditorInput) getEditorInput()).getsEffectiveName());
    }
  ...
  public void setFocus() {
    ...
    if (getActivePage() == 0) {
      ...
      this.pidcRvwResDtlsPage.setStatusBarMessage(this.pidcRvwResDtlsPage.getGroupByHeaderLayer(), false);
    }
  }
