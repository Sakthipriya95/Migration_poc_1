 ...
 * @author mkl2cob
 */
public class DaCompHEXEditConfiguration extends AbstractRegistryConfiguration {
  ...
  public void configureRegistry(final IConfigRegistry configRegistry) {
    ...
    ImagePainter imgPainter = new ImagePainter() {
      ...
      protected Image getImage(final ILayerCell cell, final IConfigRegistry configRegistry) {
        ...
        CustomFilterGridLayer<DaCompareHexParam> customFilterGridLayer =
            (CustomFilterGridLayer<DaCompareHexParam>) cell.getLayer();
        DaCompareHexParam rowObj = customFilterGridLayer.getBodyDataProvider().getRowObject(cell.getRowIndex());
