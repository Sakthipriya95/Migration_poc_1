...
/**
 * CharacteristicValue Model class
 *
 * @author dmo5cob
 */
public class CharacteristicValue implements Comparable<CharacteristicValue>, IDataObject {

  /**
   *
   */
  private static final long serialVersionUID = 6060306174375487025L;
  /**
   * Char Val Id
   */
  private Long id;
  ...
  /**
   * @param valNameEng set valNameEng
   */
  ...
  /**
   * @param valNameGer set valNameGer
   */
   ...
   */
  @Override
  public int compareTo(final CharacteristicValue object) {
  ...
  public boolean equals(final Object obj) {
    ...
    return (obj.getClass() == this.getClass()) && ModelUtil.isEqual(getId(), ((CharacteristicValue) obj).getId());
  }
