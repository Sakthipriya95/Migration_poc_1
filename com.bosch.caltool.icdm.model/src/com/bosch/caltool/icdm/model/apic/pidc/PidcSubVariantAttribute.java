 ...
 * @author bne4cob
 */
public class PidcSubVariantAttribute implements IProjectAttribute {

  /**
   *
   */
  private static final long serialVersionUID = 9180047544079337987L;
  ...
  public boolean equals(final Object obj) {
    ...
    PidcSubVariantAttribute other = (PidcSubVariantAttribute) obj;
    if (getName() == null) {
   ...
   */
  @Override
  public PidcSubVariantAttribute clone() {
    PidcSubVariantAttribute subVarAttr = null;
    try {
      subVarAttr = (PidcSubVariantAttribute) super.clone();
    }
  ...
  /**
   * @return the subVarNameValId
   */
  public Long getSubVarNameValId() {
    return this.subVarNameValId;
  }

  /**
   * @param subVarNameValId the subVarNameValId to set
   */
  public void setSubVarNameValId(final Long subVarNameValId) {
    this.subVarNameValId = subVarNameValId;
  }
