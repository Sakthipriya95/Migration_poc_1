 ...
 * @author UKT1COB
 */
public class PidcVariantCocWp implements IProjectCoCWP {
  ...
  public int compareTo(final IProjectCoCWP object) {
    int compareResult = 0;
    if (object instanceof PidcVariantCocWp) {
      compareResult = ModelUtil.compare(getName(), ((PidcVariantCocWp) object).getName());
      if (compareResult == 0) {
        compareResult = ModelUtil.compare(getId(), ((PidcVariantCocWp) object).getWPDivId());
      }
    }
  ...
  public boolean equals(final Object obj) {
    ...
    PidcVariantCocWp other = (PidcVariantCocWp) obj;
    if (getName() == null) {
   ...
   */
  @Override
  public PidcVariantCocWp clone() {
    PidcVariantCocWp varCocWp = null;
    try {
      varCocWp = (PidcVariantCocWp) super.clone();
    }
