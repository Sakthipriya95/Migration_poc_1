 ...
 * @author dja7cob
 */
public class UseCaseSectionItemType extends UsecaseTypeModel {

  private Set<Long> mappedAttrIds = new HashSet<>();

  private Set<UseCaseSectionItemType> ucSectionItemType = new HashSet<>();
  ...
  /**
   * @return the ucSectionItemType
   */
  public Set<UseCaseSectionItemType> getUcSectionItemType() {
    return this.ucSectionItemType;
  }


  /**
   * @param ucSectionItemType the ucSectionItemType to set
   */
  public void setUcSectionItemType(final Set<UseCaseSectionItemType> ucSectionItemType) {
    this.ucSectionItemType = ucSectionItemType;
  }
