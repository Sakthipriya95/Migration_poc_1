 ...
 * @author bne4cob
 */
public class UseCase implements Cloneable, Comparable<UseCase>, IUseCaseItem

{
   ...
   *
   */
  private static final long serialVersionUID = -7835068281864434779L;
  /**
   * Use Case Id
   */
  private Long id;
  ...
  /**
   * @param lastConfirmationDate set lastConfirmationDate
   */
   ...
   */
  @Override
  public int compareTo(final UseCase other) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (obj.getClass() == this.getClass()) {
      return ModelUtil.isEqual(getId(), ((UseCase) obj).getId());
    }
    return false;
  }
