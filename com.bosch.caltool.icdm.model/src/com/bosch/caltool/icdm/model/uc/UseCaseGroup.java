 ...
 * @author BNE4COB
 */
public class UseCaseGroup implements IUseCaseItem, Cloneable, Comparable<UseCaseGroup> {


  /**
   *
   */
  private static final long serialVersionUID = 9173377985023152891L;
  ...
  /**
   * @param parentGroupId set parentGroupId
   */
  public void setParentGroupId(final Long parentGroupId) {
   ...
   */
  @Override
  public UseCaseGroup clone() {
    try {
      return (UseCaseGroup) super.clone();
    }
   ...
   */
  @Override
  public int compareTo(final UseCaseGroup other) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (obj.getClass() == this.getClass()) {
      return ModelUtil.isEqual(getId(), ((UseCaseGroup) obj).getId());
    }
    return false;
  }
