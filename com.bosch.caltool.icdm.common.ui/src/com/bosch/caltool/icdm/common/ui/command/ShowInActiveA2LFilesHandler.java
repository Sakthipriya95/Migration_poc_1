 ...
 * @author NIP4COB
 */
public class ShowInActiveA2LFilesHandler extends AbstractHandler implements IHandler, IElementUpdater {
  ...
  public void updateElement(final UIElement arg0, final Map arg1) {
    arg0.setChecked(PIDTreeViewPart.displayInactiveA2LFiles());
    arg0.setChecked(FavoritesViewPart.isDisplayInactiveA2LEnabled());
  ...
  public Object execute(final ExecutionEvent event) throws ExecutionException {
    ...
    // store preferences
    this.preference.setValue(CommonUIConstants.PIDC_TREE_DISPLAY_INACTIVE_A2L_FILES,
