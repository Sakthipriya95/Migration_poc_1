 ...
 * @author mkl2cob
 */
public class AbstractWizardDialog extends WizardDialog {

  /**
   * help link key prefix for views
   */
  private static final String HELP_LINK_PREFIX = "WIZARD_";

  /**
   * @param parentShell Shell
   * @param newWizard IWizard
   */
  public AbstractWizardDialog(final Shell parentShell, final IWizard newWizard) {
