 ...
 * @author say8cob
 */
public class ShowDeletedQnaireReponseHandler extends AbstractHandler implements IHandler, IElementUpdater {
   ...
   */
  @Override
  public void updateElement(final UIElement arg0, final Map arg1) {
    arg0.setChecked(PIDTreeViewPart.isDisplayDeletedQnaireResponseEnabled());
    arg0.setChecked(FavoritesViewPart.isDisplayDeletedQnaireResponseEnabled());
  ...
  public Object execute(final ExecutionEvent event) throws ExecutionException {
    ...
    // store preferences
    this.preference.setValue(CommonUIConstants.PIDC_TREE_DISPLAY_DELETED_QNAIRE_RESP,
