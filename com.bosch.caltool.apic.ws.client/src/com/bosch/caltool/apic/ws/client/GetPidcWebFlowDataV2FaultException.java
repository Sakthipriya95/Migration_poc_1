...
public class GetPidcWebFlowDataV2FaultException extends java.lang.Exception{
    ...
    private com.bosch.caltool.apic.ws.client.APICStub.GetPidcWebFlowDataV2Fault faultMessage;
    ...
    public void setFaultMessage(com.bosch.caltool.apic.ws.client.APICStub.GetPidcWebFlowDataV2Fault msg){
       faultMessage = msg;
    }
    
    public com.bosch.caltool.apic.ws.client.APICStub.GetPidcWebFlowDataV2Fault getFaultMessage(){
       return faultMessage;
    }
}
