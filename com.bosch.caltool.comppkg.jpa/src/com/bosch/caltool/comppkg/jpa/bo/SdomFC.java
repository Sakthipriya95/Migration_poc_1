...
/**
 * FC details holder <br>
 * This POJO class holds required details of FC's
 *
 * @author adn1cob
 */
public class SdomFC implements Comparable<SdomFC> {
   ...
   */
  protected SdomFC(final String fcName, final String fcDescription) {
    this.fcName = fcName;
   ...
   */
  @Override
  public int compareTo(final SdomFC other) {
   ...
   * @return int
   */
  public int compareTo(final SdomFC param2, final SortColumns sortColumn) {
