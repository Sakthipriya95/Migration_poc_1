...
public class GetUseCasesFaultException extends java.lang.Exception{
    ...
    private com.bosch.caltool.apic.ws.GetUseCasesFault faultMessage;
    ...
    public void setFaultMessage(com.bosch.caltool.apic.ws.GetUseCasesFault msg){
       faultMessage = msg;
    }
    
    public com.bosch.caltool.apic.ws.GetUseCasesFault getFaultMessage(){
       return faultMessage;
    }
}
