...
/**
 * WebServiceVersionResponseType.java
 *
 ...
 */
            ...
            /**
            *  WebServiceVersionResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class WebServiceVersionResponseType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = WebServiceVersionResponseType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WebServiceVersionResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "WebServiceVersionResponseType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static WebServiceVersionResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WebServiceVersionResponseType object =
                new WebServiceVersionResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WebServiceVersionResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WebServiceVersionResponseType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
