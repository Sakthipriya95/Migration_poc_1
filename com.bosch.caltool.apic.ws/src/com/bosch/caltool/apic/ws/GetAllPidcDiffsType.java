 ...
 */
            ...
            /**
            *  GetAllPidcDiffsType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllPidcDiffsType extends com.bosch.caltool.apic.ws.GetPidcDiffsType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetAllPidcDiffsType
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAllPidcDiffsType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAllPidcDiffsType",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://ws.apic.caltool.bosch.com","GetAllPidcDiffsType"));
    ...
    public static class Factory{
        ...
        */
        public static GetAllPidcDiffsType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllPidcDiffsType object =
                new GetAllPidcDiffsType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAllPidcDiffsType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllPidcDiffsType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","oldPidcChangeNumber").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","newPidcChangeNumber").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","attributeId").equals(reader.getName())){
                                    ...
                                    list5.add(reader.getElementText());
                                            ...
                                            while(!loopDone5){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","attributeId").equals(reader.getName())){
                                                         list5.add(reader.getElementText());
