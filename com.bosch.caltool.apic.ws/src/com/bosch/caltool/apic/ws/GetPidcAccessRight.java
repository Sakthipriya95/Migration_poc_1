 ...
 */
            ...
            /**
            *  GetPidcAccessRight bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPidcAccessRight
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPidcAccessRight",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPidcAccessRight",
    ...
    public static class Factory{
        ...
        */
        public static GetPidcAccessRight parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPidcAccessRight object =
                new GetPidcAccessRight();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPidcAccessRight".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPidcAccessRight)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
