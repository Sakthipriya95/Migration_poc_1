...
public class GetAllPidcDiffFaultException extends java.lang.Exception{
    ...
    private com.bosch.caltool.apic.ws.AllPidcDiffFault faultMessage;
    ...
    public void setFaultMessage(com.bosch.caltool.apic.ws.AllPidcDiffFault msg){
       faultMessage = msg;
    }
    
    public com.bosch.caltool.apic.ws.AllPidcDiffFault getFaultMessage(){
       return faultMessage;
    }
}
