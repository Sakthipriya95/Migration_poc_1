...
/**
 * GetParameterStatisticsXML.java
 *
 ...
 */
            ...
            /**
            *  GetParameterStatisticsXML bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetParameterStatisticsXML
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getParameterStatisticsXML",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getParameterStatisticsXML",
    ...
    public static class Factory{
        ...
        */
        public static GetParameterStatisticsXML parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetParameterStatisticsXML object =
                new GetParameterStatisticsXML();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getParameterStatisticsXML".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetParameterStatisticsXML)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
