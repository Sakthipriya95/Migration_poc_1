...
/**
 * GetPidcAccessRightResponse.java
 *
 ...
 */
            ...
            /**
            *  GetPidcAccessRightResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPidcAccessRightResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://ws.apic.caltool.bosch.com",
                "getPidcAccessRightResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPidcAccessRightResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPidcAccessRightResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetPidcAccessRightResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPidcAccessRightResponse object =
                new GetPidcAccessRightResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPidcAccessRightResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPidcAccessRightResponse)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
