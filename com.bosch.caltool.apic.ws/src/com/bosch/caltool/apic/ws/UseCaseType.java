 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for UseCaseItems
                        * This was an Array!
                        */

                        
                                    protected com.bosch.caltool.apic.ws.UseCaseItemType[] localUseCaseItems ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.bosch.caltool.apic.ws.UseCaseItemType[]
                           */
                           public  com.bosch.caltool.apic.ws.UseCaseItemType[] getUseCaseItems(){
                               return localUseCaseItems;
                           }
                              ...
                              /**
                               * validate the array for UseCaseItems
                               */
                              protected void validateUseCaseItems(com.bosch.caltool.apic.ws.UseCaseItemType[] param){
                             ...
                             /**
                              * Auto generated setter method
                              * @param param UseCaseItems
                              */
                              public void setUseCaseItems(com.bosch.caltool.apic.ws.UseCaseItemType[] param){
                              
                                   validateUseCaseItems(param);

                               
                                      this.localUseCaseItems=param;
                              }
                             ...
                             * @param param com.bosch.caltool.apic.ws.UseCaseItemType
                             */
                             public void addUseCaseItems(com.bosch.caltool.apic.ws.UseCaseItemType param){
                                   if (localUseCaseItems == null){
                                   localUseCaseItems = new com.bosch.caltool.apic.ws.UseCaseItemType[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localUseCaseItems);
                               list.add(param);
                               this.localUseCaseItems =
                             (com.bosch.caltool.apic.ws.UseCaseItemType[])list.toArray(
                            new com.bosch.caltool.apic.ws.UseCaseItemType[list.size()]);
                           ...
                           xmlWriter);
                              ...
                              if (localModifyDateTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                       ...
                                       if (localUseCaseItems!=null){
                                            for (int i = 0;i < localUseCaseItems.length;i++){
                                                if (localUseCaseItems[i] != null){
                                                 localUseCaseItems[i].serialize(new javax.xml.namespace.QName("","useCaseItems"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                           throw new org.apache.axis2.databinding.ADBException("useCaseItems cannot be null!!");
                             ...
                             if (localUseCaseItems!=null) {
                                 for (int i = 0;i < localUseCaseItems.length;i++){
                                    ...
                                    if (localUseCaseItems[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("",
                                                                          "useCaseItems"));
                                         elementList.add(localUseCaseItems[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static UseCaseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UseCaseType object =
                new UseCaseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UseCaseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UseCaseType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list13 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","useCaseItems").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list13.add(com.bosch.caltool.apic.ws.UseCaseItemType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone13){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","useCaseItems").equals(reader.getName())){
                                                                    list13.add(com.bosch.caltool.apic.ws.UseCaseItemType.Factory.parse(reader));
                                                        ...
                                                        object.setUseCaseItems((com.bosch.caltool.apic.ws.UseCaseItemType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.bosch.caltool.apic.ws.UseCaseItemType.class,
                                                                list13));
