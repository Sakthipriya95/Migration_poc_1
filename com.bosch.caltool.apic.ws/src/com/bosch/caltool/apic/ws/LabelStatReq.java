 ...
 */
            ...
            /**
            *  LabelStatReq bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LabelStatReq
    ...
    public static class Factory{
        ...
        */
        public static LabelStatReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LabelStatReq object =
                new LabelStatReq();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"labelStatReq".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LabelStatReq)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
