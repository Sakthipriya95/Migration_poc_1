 ...
 */
            ...
            /**
            *  AttributeValueV2 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AttributeValueV2
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AttributeValueV2",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AttributeValueV2",
    ...
    public static class Factory{
        ...
        */
        public static AttributeValueV2 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AttributeValueV2 object =
                new AttributeValueV2();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AttributeValueV2".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AttributeValueV2)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
