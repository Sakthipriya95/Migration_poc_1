 ...
 */
            ...
            /**
            *  GetPidcWebFlowElement bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPidcWebFlowElement
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPidcWebFlowElement",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPidcWebFlowElement",
    ...
    public static class Factory{
        ...
        */
        public static GetPidcWebFlowElement parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPidcWebFlowElement object =
                new GetPidcWebFlowElement();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPidcWebFlowElement".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPidcWebFlowElement)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
