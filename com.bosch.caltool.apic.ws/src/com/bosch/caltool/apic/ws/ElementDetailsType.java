 ...
 */
            ...
            /**
            *  ElementDetailsType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ElementDetailsType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ElementDetailsType
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for VariantName
                        */

                        
                                    protected java.lang.String localVariantName ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localVariantNameTracker = false ;

                           public boolean isVariantNameSpecified(){
                               return localVariantNameTracker;
                           }
                           ...
                           */
                           public  java.lang.String getVariantName(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param VariantName
                               */
                               public void setVariantName(java.lang.String param){
                            localVariantNameTracker = param != null;
                                   
                                            this.localVariantName=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ElementDetailsType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ElementDetailsType",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                              if (localVariantNameTracker){
                                    namespace = "";
                                    writeStartElement(null, namespace, "variantName", xmlWriter);
                             

                                          if (localVariantName==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("variantName cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localVariantName);
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                             ...
                             if (localVariantNameTracker){
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localVariantName != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localVariantName));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("variantName cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static ElementDetailsType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ElementDetailsType object =
                new ElementDetailsType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ElementDetailsType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ElementDetailsType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","variantName").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"variantName" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setVariantName(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
