...
public abstract class Response {
   ...
   */
  protected final transient StringBuilder responseBuilder = new StringBuilder();
  ...
  private void createRequestString() {
    ...
    for (Object entry : this.request) {
      this.responseBuilder.append(getSingleResponseString(entry));
    }
  }
   ...
   */
  protected abstract String getSingleResponseString(final Object requestObject);
