 ...
 */
            ...
            /**
            *  PidcStatisticType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PidcStatisticType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PidcStatisticType
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.bosch.caltool.apic.ws.PidcStatisticFilter[] localFilter ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.bosch.caltool.apic.ws.PidcStatisticFilter[]
                           */
                           public  com.bosch.caltool.apic.ws.PidcStatisticFilter[] getFilter(){
                               return localFilter;
                           }
                               ...
                               */
                              protected void validateFilter(com.bosch.caltool.apic.ws.PidcStatisticFilter[] param){
                              ...
                              * @param param Filter
                              */
                              public void setFilter(com.bosch.caltool.apic.ws.PidcStatisticFilter[] param){
                             ...
                             * @param param com.bosch.caltool.apic.ws.PidcStatisticFilter
                             */
                             public void addFilter(com.bosch.caltool.apic.ws.PidcStatisticFilter param){
                                   if (localFilter == null){
                                   localFilter = new com.bosch.caltool.apic.ws.PidcStatisticFilter[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localFilter);
                               list.add(param);
                               this.localFilter =
                             (com.bosch.caltool.apic.ws.PidcStatisticFilter[])list.toArray(
                            new com.bosch.caltool.apic.ws.PidcStatisticFilter[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PidcStatisticType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PidcStatisticType",
    ...
    public static class Factory{
        ...
        */
        public static PidcStatisticType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PidcStatisticType object =
                new PidcStatisticType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PidcStatisticType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PidcStatisticType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(com.bosch.caltool.apic.ws.PidcStatisticFilter.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (reader.getLocalName().equals("filter")){
                                                                    list1.add(com.bosch.caltool.apic.ws.PidcStatisticFilter.Factory.parse(reader));
                                                        ...
                                                        object.setFilter((com.bosch.caltool.apic.ws.PidcStatisticFilter[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.bosch.caltool.apic.ws.PidcStatisticFilter.class,
                                                                list1));
