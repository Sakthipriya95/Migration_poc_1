...
/**
 * InvalidateWebFlowElementResponseType.java
 *
 ...
 */
            ...
            /**
            *  InvalidateWebFlowElementResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InvalidateWebFlowElementResponseType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = InvalidateWebFlowElementResponseType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InvalidateWebFlowElementResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "InvalidateWebFlowElementResponseType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static InvalidateWebFlowElementResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InvalidateWebFlowElementResponseType object =
                new InvalidateWebFlowElementResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InvalidateWebFlowElementResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InvalidateWebFlowElementResponseType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
