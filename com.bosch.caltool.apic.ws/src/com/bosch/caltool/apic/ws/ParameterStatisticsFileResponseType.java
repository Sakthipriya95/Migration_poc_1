...
/**
 * ParameterStatisticsFileResponseType.java
 *
 ...
 */
            ...
            /**
            *  ParameterStatisticsFileResponseType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ParameterStatisticsFileResponseType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ParameterStatisticsFileResponseType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ParameterStatisticsFileResponseType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ParameterStatisticsFileResponseType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static ParameterStatisticsFileResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ParameterStatisticsFileResponseType object =
                new ParameterStatisticsFileResponseType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ParameterStatisticsFileResponseType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ParameterStatisticsFileResponseType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
