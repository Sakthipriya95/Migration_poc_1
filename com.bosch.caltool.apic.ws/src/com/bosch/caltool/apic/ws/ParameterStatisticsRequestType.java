...
/**
 * ParameterStatisticsRequestType.java
 *
 ...
 */
            ...
            /**
            *  ParameterStatisticsRequestType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ParameterStatisticsRequestType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ParameterStatisticsRequestType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ParameterStatisticsRequestType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ParameterStatisticsRequestType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static ParameterStatisticsRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ParameterStatisticsRequestType object =
                new ParameterStatisticsRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ParameterStatisticsRequestType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ParameterStatisticsRequestType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && reader.getLocalName().equals("parameterName")){
