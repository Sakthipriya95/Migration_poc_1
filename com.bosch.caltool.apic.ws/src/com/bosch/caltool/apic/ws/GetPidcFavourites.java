 ...
 */
            ...
            /**
            *  GetPidcFavourites bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPidcFavourites
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPidcFavourites",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPidcFavourites",
    ...
    public static class Factory{
        ...
        */
        public static GetPidcFavourites parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPidcFavourites object =
                new GetPidcFavourites();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPidcFavourites".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPidcFavourites)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
