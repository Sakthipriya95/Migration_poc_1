 ...
 */
            ...
            /**
            *  GetAttrGroups bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAttrGroups
    ...
    public static class Factory{
        ...
        */
        public static GetAttrGroups parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAttrGroups object =
                new GetAttrGroups();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAttrGroups".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAttrGroups)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
