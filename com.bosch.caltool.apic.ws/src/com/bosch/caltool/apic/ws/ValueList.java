 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.bosch.caltool.apic.ws.AttributeValue[] localValues ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.bosch.caltool.apic.ws.AttributeValue[] getValues(){
                               return localValues;
                           }
                               ...
                               */
                              protected void validateValues(com.bosch.caltool.apic.ws.AttributeValue[] param){
                              ...
                              * @param param Values
                              */
                              public void setValues(com.bosch.caltool.apic.ws.AttributeValue[] param){
                             ...
                             * @param param com.bosch.caltool.apic.ws.AttributeValue
                             */
                             public void addValues(com.bosch.caltool.apic.ws.AttributeValue param){
                                   if (localValues == null){
                                   localValues = new com.bosch.caltool.apic.ws.AttributeValue[]{};
                                   }
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localValues);
                               list.add(param);
                               this.localValues =
                             (com.bosch.caltool.apic.ws.AttributeValue[])list.toArray(
                            new com.bosch.caltool.apic.ws.AttributeValue[list.size()]);
                                       ...
                                       if (localValues!=null){
                                            for (int i = 0;i < localValues.length;i++){
                                                if (localValues[i] != null){
                                                 localValues[i].serialize(new javax.xml.namespace.QName("","values"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static ValueList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValueList object =
                new ValueList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ValueList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValueList)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    list2.add(com.bosch.caltool.apic.ws.AttributeValue.Factory.parse(reader));
                                                        ...
                                                        object.setValues((com.bosch.caltool.apic.ws.AttributeValue[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.bosch.caltool.apic.ws.AttributeValue.class,
                                                                list2));
