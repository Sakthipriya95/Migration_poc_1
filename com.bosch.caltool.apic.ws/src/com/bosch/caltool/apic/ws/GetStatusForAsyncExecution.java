...
/**
 * GetStatusForAsyncExecution.java
 *
 ...
 */
            ...
            /**
            *  GetStatusForAsyncExecution bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetStatusForAsyncExecution
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getStatusForAsyncExecution",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getStatusForAsyncExecution",
    ...
    public static class Factory{
        ...
        */
        public static GetStatusForAsyncExecution parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetStatusForAsyncExecution object =
                new GetStatusForAsyncExecution();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getStatusForAsyncExecution".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetStatusForAsyncExecution)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && reader.getLocalName().equals("in")){
