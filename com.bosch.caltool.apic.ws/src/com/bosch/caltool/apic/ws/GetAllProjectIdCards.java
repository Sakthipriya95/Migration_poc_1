 ...
 */
            ...
            /**
            *  GetAllProjectIdCards bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllProjectIdCards
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllProjectIdCards",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllProjectIdCards",
    ...
    public static class Factory{
        ...
        */
        public static GetAllProjectIdCards parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllProjectIdCards object =
                new GetAllProjectIdCards();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllProjectIdCards".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllProjectIdCards)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
