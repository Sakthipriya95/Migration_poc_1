...
/**
 * GetParameterStatisticsXMLResponse.java
 *
 ...
 */
            ...
            /**
            *  GetParameterStatisticsXMLResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetParameterStatisticsXMLResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://ws.apic.caltool.bosch.com",
                "getParameterStatisticsXMLResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getParameterStatisticsXMLResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getParameterStatisticsXMLResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetParameterStatisticsXMLResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetParameterStatisticsXMLResponse object =
                new GetParameterStatisticsXMLResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getParameterStatisticsXMLResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetParameterStatisticsXMLResponse)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
