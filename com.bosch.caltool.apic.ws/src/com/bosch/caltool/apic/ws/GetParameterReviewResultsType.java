...
/**
 * GetParameterReviewResultsType.java
 *
 ...
 */
            ...
            /**
            *  GetParameterReviewResultsType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetParameterReviewResultsType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetParameterReviewResultsType
                        ...
                        */
                           ...
                           */
                           public  long[] getParameterId(){
                              ...
                              /**
                               * validate the array for ParameterId
                               */
                              protected void validateParameterId(long[] param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetParameterReviewResultsType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetParameterReviewResultsType",
                           xmlWriter);
                   }
                             ...
                             if (localParameterId!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localParameterId.length;i++){
                                        
                                                   if (localParameterId[i]!=java.lang.Long.MIN_VALUE) {
                                               
                                                writeStartElement(null, namespace, "parameterId", xmlWriter);

                                            
                                                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localParameterId[i]));
                                                xmlWriter.writeEndElement();
                            ...
                            if (localParameterId!=null){
                                  for (int i = 0;i < localParameterId.length;i++){
                                          ...
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                                                                       "parameterId"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localParameterId[i]));
    ...
    public static class Factory{
        ...
        */
        public static GetParameterReviewResultsType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetParameterReviewResultsType object =
                new GetParameterReviewResultsType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetParameterReviewResultsType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetParameterReviewResultsType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && reader.getLocalName().equals("parameterId")){
                                    ...
                                    list2.add(reader.getElementText());
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (reader.getLocalName().equals("parameterId")){
                                                         list2.add(reader.getElementText());
