...
import com.bosch.calcomp.caldataanalyzer.filter.datasetfilter.impl.A2LBaseCompFilter;
 ...
 */
public class BaseCompAdapter extends AbstractSeriesStatisticsFilter {

  /**
   * The A2LSysConstFilter as the result of the Translation process.
   */
  private final transient A2LBaseCompFilter iFilter;
   ...
   */
  public BaseCompAdapter(final DefaultSeriesStatisticsFilterType filter, final DataHolder dataHolder) {
    super(filter, dataHolder);
    super.dataType = AbstractSeriesStatisticsFilter.DataType.BASE_COMPONENTS_FILTER;
    this.iFilter = new A2LBaseCompFilter(filter.getName(), filter.getValue().getStringValue());
  }
