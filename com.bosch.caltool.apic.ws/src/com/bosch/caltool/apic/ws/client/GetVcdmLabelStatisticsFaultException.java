...
public class GetVcdmLabelStatisticsFaultException extends java.lang.Exception{
    ...
    private static final long serialVersionUID = 1518698935357L;
    
    private com.bosch.caltool.apic.ws.client.APICStub.GetVcdmLabelStatisticsFault faultMessage;
    ...
    public void setFaultMessage(com.bosch.caltool.apic.ws.client.APICStub.GetVcdmLabelStatisticsFault msg){
       faultMessage = msg;
    }
    
    public com.bosch.caltool.apic.ws.client.APICStub.GetVcdmLabelStatisticsFault getFaultMessage(){
       return faultMessage;
    }
}
