 ...
 */
            ...
            /**
            *  PidcActiveVersionType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PidcActiveVersionType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PidcActiveVersionType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PidcActiveVersionType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PidcActiveVersionType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static PidcActiveVersionType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PidcActiveVersionType object =
                new PidcActiveVersionType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PidcActiveVersionType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PidcActiveVersionType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
