 ...
 */
            ...
            /**
            *  AllPidcDiffType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AllPidcDiffType extends com.bosch.caltool.apic.ws.GetPidcDiffsType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AllPidcDiffType
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AllPidcDiffType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AllPidcDiffType",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://ws.apic.caltool.bosch.com","AllPidcDiffType"));
    ...
    public static class Factory{
        ...
        */
        public static AllPidcDiffType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AllPidcDiffType object =
                new AllPidcDiffType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AllPidcDiffType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AllPidcDiffType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
