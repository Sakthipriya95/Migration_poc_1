...
public class GetAllPidcDiffForVersionFaultException extends java.lang.Exception{
    ...
    private com.bosch.caltool.apic.ws.GetAllPidcDiffForVersionFault faultMessage;
    ...
    public void setFaultMessage(com.bosch.caltool.apic.ws.GetAllPidcDiffForVersionFault msg){
       faultMessage = msg;
    }
    
    public com.bosch.caltool.apic.ws.GetAllPidcDiffForVersionFault getFaultMessage(){
       return faultMessage;
    }
}
