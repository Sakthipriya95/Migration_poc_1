...
/**
 * ProjectIdCardAllVersInfoType.java
 *
 ...
 */
            ...
            /**
            *  ProjectIdCardAllVersInfoType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ProjectIdCardAllVersInfoType extends com.bosch.caltool.apic.ws.ProjectIdCardInfoType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ProjectIdCardAllVersInfoType
                ...
                */
                        ...
                        /**
                        * field for PidcVersions
                        * This was an Array!
                        */

                        
                                    protected com.bosch.caltool.apic.ws.PidcVersionType[] localPidcVersions ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.bosch.caltool.apic.ws.PidcVersionType[]
                           */
                           public  com.bosch.caltool.apic.ws.PidcVersionType[] getPidcVersions(){
                               return localPidcVersions;
                           }
                              ...
                              /**
                               * validate the array for PidcVersions
                               */
                              protected void validatePidcVersions(com.bosch.caltool.apic.ws.PidcVersionType[] param){
                              ...
                              * @param param PidcVersions
                              */
                              public void setPidcVersions(com.bosch.caltool.apic.ws.PidcVersionType[] param){
                              
                                   validatePidcVersions(param);

                               
                                      this.localPidcVersions=param;
                              }
                             ...
                             * @param param com.bosch.caltool.apic.ws.PidcVersionType
                             */
                             public void addPidcVersions(com.bosch.caltool.apic.ws.PidcVersionType param){
                                   if (localPidcVersions == null){
                                   localPidcVersions = new com.bosch.caltool.apic.ws.PidcVersionType[]{};
                                   }

                            

                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPidcVersions);
                               list.add(param);
                               this.localPidcVersions =
                             (com.bosch.caltool.apic.ws.PidcVersionType[])list.toArray(
                            new com.bosch.caltool.apic.ws.PidcVersionType[list.size()]);
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ProjectIdCardAllVersInfoType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ProjectIdCardAllVersInfoType",
                           xmlWriter);
                   }
                              ...
                              if (localModifyDateTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                       ...
                                       if (localLevelAttrInfoList!=null){
                                            for (int i = 0;i < localLevelAttrInfoList.length;i++){
                                                if (localLevelAttrInfoList[i] != null){
                                                 localLevelAttrInfoList[i].serialize(new javax.xml.namespace.QName("","levelAttrInfoList"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                           throw new org.apache.axis2.databinding.ADBException("levelAttrInfoList cannot be null!!");
                                   ...
                                   xmlWriter.writeEndElement();
                                       ...
                                       if (localPidcVersions!=null){
                                            for (int i = 0;i < localPidcVersions.length;i++){
                                                if (localPidcVersions[i] != null){
                                                 localPidcVersions[i].serialize(new javax.xml.namespace.QName("","pidcVersions"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                           throw new org.apache.axis2.databinding.ADBException("pidcVersions cannot be null!!");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://ws.apic.caltool.bosch.com","ProjectIdCardAllVersInfoType"));
                             ...
                             if (localLevelAttrInfoList!=null) {
                                 for (int i = 0;i < localLevelAttrInfoList.length;i++){
                                    ...
                                    if (localLevelAttrInfoList[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("",
                                                                          "levelAttrInfoList"));
                                         elementList.add(localLevelAttrInfoList[i]);
                                    } else {
                             ...
                             if (localPidcVersions!=null) {
                                 for (int i = 0;i < localPidcVersions.length;i++){
                                    ...
                                    if (localPidcVersions[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("",
                                                                          "pidcVersions"));
                                         elementList.add(localPidcVersions[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static ProjectIdCardAllVersInfoType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProjectIdCardAllVersInfoType object =
                new ProjectIdCardAllVersInfoType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ProjectIdCardAllVersInfoType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ProjectIdCardAllVersInfoType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list13 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","versionNumber").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","levelAttrInfoList").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list10.add(com.bosch.caltool.apic.ws.LevelAttrInfo.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone10){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","levelAttrInfoList").equals(reader.getName())){
                                                                    list10.add(com.bosch.caltool.apic.ws.LevelAttrInfo.Factory.parse(reader));
                                                        ...
                                                        object.setLevelAttrInfoList((com.bosch.caltool.apic.ws.LevelAttrInfo[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.bosch.caltool.apic.ws.LevelAttrInfo.class,
                                                                list10));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","pidcVersions").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list13.add(com.bosch.caltool.apic.ws.PidcVersionType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone13){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","pidcVersions").equals(reader.getName())){
                                                                    list13.add(com.bosch.caltool.apic.ws.PidcVersionType.Factory.parse(reader));
                                                        ...
                                                        object.setPidcVersions((com.bosch.caltool.apic.ws.PidcVersionType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.bosch.caltool.apic.ws.PidcVersionType.class,
                                                                list13));
