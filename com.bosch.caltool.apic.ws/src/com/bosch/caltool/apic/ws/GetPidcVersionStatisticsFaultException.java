...
public class GetPidcVersionStatisticsFaultException extends java.lang.Exception{
    ...
    private com.bosch.caltool.apic.ws.GetPidcVersionStatisticsFault faultMessage;
    ...
    public void setFaultMessage(com.bosch.caltool.apic.ws.GetPidcVersionStatisticsFault msg){
       faultMessage = msg;
    }
    
    public com.bosch.caltool.apic.ws.GetPidcVersionStatisticsFault getFaultMessage(){
       return faultMessage;
    }
}
