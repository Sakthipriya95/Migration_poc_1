 ...
 */
            ...
            /**
            *  GetPidcVersionStatistics bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPidcVersionStatistics
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPidcVersionStatistics",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPidcVersionStatistics",
    ...
    public static class Factory{
        ...
        */
        public static GetPidcVersionStatistics parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPidcVersionStatistics object =
                new GetPidcVersionStatistics();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPidcVersionStatistics".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPidcVersionStatistics)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
