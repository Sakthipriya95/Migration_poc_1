...
public class GetPidcWebFlowElementFault1 extends java.lang.Exception{
    ...
    private com.bosch.caltool.apic.ws.GetPidcWebFlowElementFault faultMessage;
    ...
    public void setFaultMessage(com.bosch.caltool.apic.ws.GetPidcWebFlowElementFault msg){
       faultMessage = msg;
    }
