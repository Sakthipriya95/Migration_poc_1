...
/**
 * GetParameterStatisticsType.java
 *
 ...
 */
            ...
            /**
            *  GetParameterStatisticsType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetParameterStatisticsType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = GetParameterStatisticsType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetParameterStatisticsType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetParameterStatisticsType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static GetParameterStatisticsType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetParameterStatisticsType object =
                new GetParameterStatisticsType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetParameterStatisticsType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetParameterStatisticsType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
