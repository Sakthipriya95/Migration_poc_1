 ...
 */
            ...
            /**
            *  GetWebServiceVersion bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetWebServiceVersion
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getWebServiceVersion",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getWebServiceVersion",
    ...
    public static class Factory{
        ...
        */
        public static GetWebServiceVersion parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetWebServiceVersion object =
                new GetWebServiceVersion();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getWebServiceVersion".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetWebServiceVersion)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
