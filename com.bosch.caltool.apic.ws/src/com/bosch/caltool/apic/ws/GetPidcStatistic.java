 ...
 */
            ...
            /**
            *  GetPidcStatistic bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPidcStatistic
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPidcStatistic",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPidcStatistic",
    ...
    public static class Factory{
        ...
        */
        public static GetPidcStatistic parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPidcStatistic object =
                new GetPidcStatistic();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPidcStatistic".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPidcStatistic)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
