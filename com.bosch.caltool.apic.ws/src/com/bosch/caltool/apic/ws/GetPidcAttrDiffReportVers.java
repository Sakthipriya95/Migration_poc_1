...
/**
 * GetPidcAttrDiffReportVers.java
 *
 ...
 */
            ...
            /**
            *  GetPidcAttrDiffReportVers bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPidcAttrDiffReportVers
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://ws.apic.caltool.bosch.com",
                "getPidcAttrDiffReportVers",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPidcAttrDiffReportVers",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPidcAttrDiffReportVers",
    ...
    public static class Factory{
        ...
        */
        public static GetPidcAttrDiffReportVers parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPidcAttrDiffReportVers object =
                new GetPidcAttrDiffReportVers();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPidcAttrDiffReportVers".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPidcAttrDiffReportVers)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
