...
public class PIDCChangedVariantHistAdapterType extends ProjectIdCardChangedVariantsType
  ...
  public PIDCChangedVariantHistAdapterType() {
    // TO-DO
  }

  public PIDCChangedVariantHistAdapterType(final PidcChangeHistory histEntry) throws IcdmException {
    this(histEntry, histEntry);
  }

  public PIDCChangedVariantHistAdapterType(final PidcChangeHistory histEntryOld, final PidcChangeHistory histEntryNew)
  ...
  public void removeEquals() {
    ...
    if ((getNewDesc() != null) || (getOldDesc() != null)) {
      if (this.histEntryOld.getNewValueId() != null) {
