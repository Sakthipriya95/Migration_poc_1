 ...
 */
            ...
            /**
            *  WebFlowAttrValuesType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class WebFlowAttrValuesType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = webFlowAttrValuesType
                ...
                */
                        ...
                        */
                                    ...
                                    protected java.lang.String localValueDesc ;
                           ...
                           */
                           public  java.lang.String getValueDesc(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ValueDesc
                               */
                               public void setValueDesc(java.lang.String param){
                            
                                            this.localValueDesc=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":webFlowAttrValuesType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "webFlowAttrValuesType",
                           xmlWriter);
                   }
                                    ...
                                    writeStartElement(null, namespace, "valueName", xmlWriter);
                                          ...
                                          if (localValueName==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("valueName cannot be null!!");
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "valueDesc", xmlWriter);
                             

                                          if (localValueDesc==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("valueDesc cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localValueDesc);
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localValueID));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localValueName != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localValueName));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("valueName cannot be null!!");
                                        }
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localValueDesc != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localValueDesc));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("valueDesc cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static WebFlowAttrValuesType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WebFlowAttrValuesType object =
                new WebFlowAttrValuesType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"webFlowAttrValuesType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WebFlowAttrValuesType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","valueName").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"valueName" +"  cannot be null");
                                    }
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","valueDesc").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"valueDesc" +"  cannot be null");
                                    }
