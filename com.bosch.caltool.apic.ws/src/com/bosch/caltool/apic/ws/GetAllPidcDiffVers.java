 ...
 */
            ...
            /**
            *  GetAllPidcDiffVers bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllPidcDiffVers
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllPidcDiffVers",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllPidcDiffVers",
    ...
    public static class Factory{
        ...
        */
        public static GetAllPidcDiffVers parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllPidcDiffVers object =
                new GetAllPidcDiffVers();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllPidcDiffVers".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllPidcDiffVers)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
