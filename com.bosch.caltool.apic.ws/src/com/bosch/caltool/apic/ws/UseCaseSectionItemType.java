 ...
 */
            ...
            /**
            *  UseCaseSectionItemType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UseCaseSectionItemType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = UseCaseSectionItemType
                ...
                */
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localUseCaseSectionItemsTracker = false ;

                           public boolean isUseCaseSectionItemsSpecified(){
                               return localUseCaseSectionItemsTracker;
                           }
                           ...
                           public  com.bosch.caltool.apic.ws.UseCaseSectionItemType[] getUseCaseSectionItems(){
                              ...
                              */
                              public void setUseCaseSectionItems(com.bosch.caltool.apic.ws.UseCaseSectionItemType[] param){
                               ...
                               localUseCaseSectionItemsTracker = param != null;
                             ...
                             */
                             public void addUseCaseSectionItems(com.bosch.caltool.apic.ws.UseCaseSectionItemType param){
                                ...
                                localUseCaseSectionItemsTracker = true;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UseCaseSectionItemType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UseCaseSectionItemType",
                           xmlWriter);
                   }
                        ...
                        } if (localUseCaseSectionItemsTracker){
                                       if (localUseCaseSectionItems!=null){
    ...
    public static class Factory{
        ...
        */
        public static UseCaseSectionItemType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UseCaseSectionItemType object =
                new UseCaseSectionItemType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UseCaseSectionItemType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UseCaseSectionItemType)com.bosch.caltool.apic.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list12 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                    list12.add(com.bosch.caltool.apic.ws.UseCaseSectionItemType.Factory.parse(reader));
