 ...
 * @author PDH2COB
 */
public class PidcCoCWpNattableNattoolTip extends NatTableContentTooltip {
   ...
   */
  public PidcCoCWpNattableNattoolTip(final NatTable nattable, final String[] tooltipRegions) {
