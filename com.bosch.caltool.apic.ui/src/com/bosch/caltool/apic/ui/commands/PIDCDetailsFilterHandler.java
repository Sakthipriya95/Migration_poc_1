...
/**
 * Handler class for filters in pidc details menu
 *
 * @author adn1cob
 */
public class PIDCDetailsFilterHandler extends AbstractHandler implements IHandler, IElementUpdater {
  ...
  public Object execute(final ExecutionEvent event) throws ExecutionException {
    ...
    // store preferences
    this.preference.setValue(ApicUiConstants.PIDC_DETAILS_SHOW_DELETED,
  ...
  public void updateElement(final UIElement element, final Map parameters) {
    element.setChecked(PIDCDetailsViewPart.isDeletedNodesDisplayEnabled());
  }
