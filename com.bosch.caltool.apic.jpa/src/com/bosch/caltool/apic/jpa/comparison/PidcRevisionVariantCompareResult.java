 ...
 * @author jvi6cob
 */
public class PidcRevisionVariantCompareResult extends AbstractCompareResult implements
    Comparable<PidcRevisionVariantCompareResult> {
   ...
   */
  private Map<PIDCSubVariant, PidcCompareResult> subVariantMap;
  /**
   ...
   */
  @Override
  public int compareTo(final PidcRevisionVariantCompareResult arg0) {
   ...
   */
  public Map<PIDCSubVariant, PidcCompareResult> getSubVariantMap() {
   ...
   */
  public void setSubVariantMap(final Map<PIDCSubVariant, PidcCompareResult> subVariantMap) {
