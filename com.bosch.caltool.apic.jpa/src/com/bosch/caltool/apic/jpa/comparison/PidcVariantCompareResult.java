 ...
 * @author jvi6cob
 */
public class PidcVariantCompareResult extends AbstractCompareResult implements Comparable<PidcVariantCompareResult> {
   ...
   */
  private Map<PIDCVariant, Map<PIDCSubVariant, PidcCompareResult>> variantSubVariantMap;
  /**
   ...
   */
  @Override
  public int compareTo(final PidcVariantCompareResult arg0) {
  ...
  /**
   * @return variantSubVariantMap
   */
  public Map<PIDCVariant, Map<PIDCSubVariant, PidcCompareResult>> getVariantSubVariantMap() {
    return this.variantSubVariantMap;
  }


  /**
   * @param variantSubVariantMap Variant Subvariant Map
   */
  public void setVariantSubVariantMap(
      final Map<PIDCVariant, Map<PIDCSubVariant, PidcCompareResult>> variantSubVariantMap) {
    this.variantSubVariantMap = variantSubVariantMap;
  }
