...
/**
 * PidcCompareResult.java - This class holds the result of comparison, each row is being an instance of this object. The
 * List/set of this objects is the result of comparison
 *
 * @author adn1cob
 */
public class PidcCompareResult extends AbstractCompareResult implements Comparable<PidcCompareResult> {
   ...
   */
  @Override
  public int compareTo(final PidcCompareResult arg0) {
