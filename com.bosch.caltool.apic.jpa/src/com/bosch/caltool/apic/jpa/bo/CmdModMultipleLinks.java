...
/**
 * ICDM-1502 Command for handling multiple links
 * 
 * @author mkl2cob
 */
public class CmdModMultipleLinks extends AbstractCommand {
   ...
   */
  private final List<CmdModLinks> cmdList = new ArrayList<CmdModLinks>();
   ...
   * @param dataObj TODO
   */
  public CmdModMultipleLinks(final AbstractDataProvider dataProvider, final AbstractDataObject dataObj) {
    super(dataProvider);
  ...
  protected void executeUpdateCommand() throws CommandException {
    for (CmdModLinks cmd : this.cmdList) {
   ...
   */
  public void addChildCommand(final CmdModLinks command) throws CommandException {
   ...
   */
  public List<CmdModLinks> getCommandList() {
    return this.cmdList;
  }
