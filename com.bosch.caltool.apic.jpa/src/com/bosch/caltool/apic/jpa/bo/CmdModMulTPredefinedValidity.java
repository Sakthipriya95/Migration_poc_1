 ...
 * @author bru2cob
 */
public class CmdModMulTPredefinedValidity extends AbstractCommand {
   ...
   */
  private final List<CmdModTPredefinedValidity> cmdList = new ArrayList<CmdModTPredefinedValidity>();
   ...
   * @param dataProvider
   */
  public CmdModMulTPredefinedValidity(final AbstractDataProvider dataProvider, final AbstractDataObject dataObj) {
    super(dataProvider);
  ...
  protected void executeUpdateCommand() throws CommandException {
    for (CmdModTPredefinedValidity cmd : this.cmdList) {
  ...
  protected boolean dataChanged() {
    ...
    return (this.cmdList != null) && !this.cmdList.isEmpty();
  }
  ...
  public String getPrimaryObjectType() {
    return "Multiple Attribute validity";
  }
   ...
   */
  public void addChildCommand(final CmdModTPredefinedValidity command) throws CommandException {
   ...
   */
  public List<CmdModTPredefinedValidity> getCommandList() {
    return this.cmdList;
  }
}
