 ...
 * @author bru2cob
 */
public class CmdModMulPredefinedAttrVal extends AbstractCommand {
   ...
   */
  private final List<CmdModPredefinedAttrVal> cmdList = new ArrayList<CmdModPredefinedAttrVal>();
   ...
   * @param dataProvider
   */
  public CmdModMulPredefinedAttrVal(final AbstractDataProvider dataProvider, final AbstractDataObject dataObj) {
    super(dataProvider);
  ...
  protected void executeUpdateCommand() throws CommandException {
    for (CmdModPredefinedAttrVal cmd : this.cmdList) {
   ...
   */
  public void addChildCommand(final CmdModPredefinedAttrVal command) throws CommandException {
   ...
   */
  public List<CmdModPredefinedAttrVal> getCommandList() {
    return this.cmdList;
  }
