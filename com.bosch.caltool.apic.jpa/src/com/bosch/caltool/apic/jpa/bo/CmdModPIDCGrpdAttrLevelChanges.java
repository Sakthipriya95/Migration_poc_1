 ...
 * @author dmo5cob
 */
public class CmdModPIDCGrpdAttrLevelChanges extends AbstractCommand {
   ...
   */
  private final List<AbstractCmdMoveAttribute> cmdMovePrjAttrList = new ArrayList<AbstractCmdMoveAttribute>();
   ...
   */
  public CmdModPIDCGrpdAttrLevelChanges(final AbstractDataProvider dataProvider, final AbstractDataObject dataObj) {
    super(dataProvider);
  ...
  protected void executeUpdateCommand() throws CommandException {
    ...
    for (AbstractCmdMoveAttribute cmd : this.cmdMovePrjAttrList) {
  ...
  protected boolean dataChanged() {
    ...
    return CommonUtils.isNotEmpty(this.cmdMovePrjAttrList);
  }
  ...
  public String getPrimaryObjectType() {
    return "Level movements of attributes";
  }
   ...
   */
  public void addMoveChildCommand(final AbstractCmdMoveAttribute command) throws CommandException {
    this.cmdMovePrjAttrList.add(command);
  }
