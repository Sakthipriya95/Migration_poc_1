 ...
 * @author adn1cob
 */
public class AttributeValueNotUsed extends AttributeValueDummy {
   ...
   */
  public AttributeValueNotUsed(final ApicDataProvider apicDataProvider, final Attribute attribute) {
    super(apicDataProvider, attribute, ApicConstants.ATTR_VAL_NOT_USED_VALUE_ID);
