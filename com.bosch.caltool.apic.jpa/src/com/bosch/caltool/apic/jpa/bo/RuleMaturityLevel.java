...
public enum RuleMaturityLevel {
   ...
   */
  public static RuleMaturityLevel getIcdmMaturityLevel(final String ssdMaturityLevel) {
  ...
  public static String getIcdmMaturityLevelText(final String ssdMaturityLevel) {
    return getIcdmMaturityLevel(ssdMaturityLevel).getICDMMaturityLevel();
  }
   ...
   * @return String
   */
  public static String getICDMMaturityLevel(final String text) {
    for (RuleMaturityLevel level : RuleMaturityLevel.values()) {
