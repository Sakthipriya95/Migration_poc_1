...
public interface IRuleManager {
   ...
   */
  List<CDRRule> readRule(final String labelName) throws SsdInterfaceException;
   ...
   * @throws SsdInterfaceException
   */
  Map<String, List<CDRRule>> readRule(final List<String> labelNames) throws SsdInterfaceException;
   ...
   * @throws SsdInterfaceException
   */
  Map<String, List<CDRRule>> readAllRules() throws SsdInterfaceException;
   ...
   * @throws SsdInterfaceException
   */
  List<CDRRuleExt> getRuleHistory(final CDRRule rule) throws SsdInterfaceException;
   ...
   */
  List<CDRRuleExt> getRuleHistoryForNodeCompli(final CDRRule rule) throws IcdmException;
}
