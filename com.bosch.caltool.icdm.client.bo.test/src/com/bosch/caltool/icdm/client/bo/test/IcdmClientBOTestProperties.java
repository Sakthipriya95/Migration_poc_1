 ...
 * @author pdh2cob
 */
public final class IcdmClientBOTestProperties {
  ...
  private static final String BUNDLE_NAME = "com.bosch.caltool.icdm.client.bo.test.IcdmClientBOTestConfig";

  private static ResourceBundle resourceBundle = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault());

  private IcdmClientBOTestProperties() {}
