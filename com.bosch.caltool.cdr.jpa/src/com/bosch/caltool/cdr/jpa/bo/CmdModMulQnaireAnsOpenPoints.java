 ...
 * @author bru2cob
 */
public class CmdModMulQnaireAnsOpenPoints extends AbstractCDRCommand {
   ...
   */
  private final List<CmdModQnaireAnsOpenPoints> cmdList = new ArrayList<CmdModQnaireAnsOpenPoints>();
   ...
   * @param dataObj TODO
   */
  public CmdModMulQnaireAnsOpenPoints(final CDRDataProvider dataProvider, final AbstractDataObject dataObj) {
    super(dataProvider);
  ...
  protected void executeUpdateCommand() throws CommandException {
    for (CmdModQnaireAnsOpenPoints cmd : this.cmdList) {
   ...
   */
  public void addChildCommand(final CmdModQnaireAnsOpenPoints command) throws CommandException {
   ...
   */
  public List<CmdModQnaireAnsOpenPoints> getCommandList() {
    return this.cmdList;
  }
