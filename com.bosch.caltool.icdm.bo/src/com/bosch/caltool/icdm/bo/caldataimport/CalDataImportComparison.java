 ...
 * @author bne4cob
 */
public class CalDataImportComparison extends AbstractSimpleBusinessObject
    implements Comparable<CalDataImportComparison> {
  ...
  public CalDataImportComparison(final String paramName, final String paramType,
      final ArrayList<FeatureValueModel> dependencyList, final ServiceData serviceData) {
    super(serviceData);
   ...
   */
  public CalData getOldRefValue() throws DataException {
    CalData oldRefValueCalData = this.oldRule == null ? null : getRefVal(this.oldRule.getRefValueCalData());
    if ((oldRefValueCalData == null) && (null != getOldRule()) && (CDRRule.VALUE_TEXT).equals(this.paramType) &&
      ...
      oldRefValueCalData = adapter.dcmToCalData(getOldRule().getRefValueDcmString(), getOldRule().getParameterName());
    }
  ...
  /**
   * @param refValueCalData
   * @return
   * @throws DataException
   */
  private CalData getRefVal(final byte[] refValueCalData) throws DataException {
    CalData caldataObj = null;
    try {
      caldataObj = CalDataUtil.getCalDataObj(refValueCalData);
    }
   ...
   * @throws DataException
   */
  public String getOldRefValueDisplay() throws DataException {
   ...
   * @throws DataException
   */
  public CalData getNewRefValue() throws DataException {
    CalData newRefValueCalData = this.newRule == null ? null : getRefVal(this.newRule.getRefValueCalData());
    if ((newRefValueCalData == null) && (null != getNewRule()) && (CDRRule.VALUE_TEXT).equals(this.paramType) &&
      ...
      ReviewRuleAdapter adapter = new ReviewRuleAdapter(getServiceData());
      newRefValueCalData = adapter.dcmToCalData(getNewRule().getRefValueDcmString(), getNewRule().getParameterName());
    }
   ...
   * @throws DataException
   */
  public String getNewRefValueDisplay() throws DataException {
  ...
  private void initialiseHint(final String defaultComment, final String oldHint) {
    ...
    this.newRule.setUnicodeRemarks(hint.toString());
