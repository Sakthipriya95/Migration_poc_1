...
public class PidcVersionBO {
   ...
   */
  public PidcVersionBO(final PidcVersionWithDetails pidcVersionWithDetails) {
  ...
  public int compare(final PidcVersionAttribute pAttr1, final PidcVersionAttribute pAttr2, final int sortColumn) {
    ...
    if (ret == 0) {
      ret = compareProjAttrs(pAttr1, pAttr2, sortColumn);
    }
   ...
   * @return compare result
   */
  private int compareProjAttrs(final IProjectAttribute pAttr1, final IProjectAttribute pAttr2, final int sortColumn) {
  ...
  private int compareAttrSuperGroup(final Attribute attr1, final Attribute attr2) {
    AttrGroup grp1 = this.pidcVersionWithDetails.getAllAttributeGroupMap().get(attr1.getAttrGrpId());
    AttrGroup grp2 = this.pidcVersionWithDetails.getAllAttributeGroupMap().get(attr2.getAttrGrpId());
    AttrSuperGroup sgrp1 = this.pidcVersionWithDetails.getAllAttributeSuperGroup().get(grp1.getSuperGrpId());
    AttrSuperGroup sgrp2 = this.pidcVersionWithDetails.getAllAttributeSuperGroup().get(grp2.getSuperGrpId());
