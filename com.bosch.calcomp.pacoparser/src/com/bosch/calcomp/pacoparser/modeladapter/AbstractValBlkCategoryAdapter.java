 ...
 */
/**
 * Class for adapting the specific details of a VALUE_BLOCK .
 * 
 * @author par7kor
 * 
 */
public abstract class AbstractValBlkCategoryAdapter implements ICategoryAdapter,
		ISWInsPropVariantAdapter {
   ...
   */
  public void setUnit(String unit, SwUnitsCreator swUnitsCreator) throws PacoParserException {
//    not required
  }
