 ...
 */
/**
 * Class for adpating the specific details of a ASCII (Characteristic Text) .
 * 
 * @author par7kor
 * 
 */
public abstract class AbstractAsciiCategoryAdapter implements ISWInsPropVariantAdapter,
		ICategoryAdapter {
