package com.bosch.rcputils.porting;
...
public class CrossPlatformSupport {
  ...
  /**
   * Determines if the given style bits is supported on the current Platform. Information about this is to be added as
   * needed. Returns always true if not known.
   */
