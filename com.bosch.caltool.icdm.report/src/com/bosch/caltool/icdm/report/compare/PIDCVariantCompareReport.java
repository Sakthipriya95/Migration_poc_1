...
// * @author jvi6cob
// */
//public class PIDCVariantCompareReport extends AbstractCompareReport {
//
...
//
//  private static final int PIDC_VAR_REP_BEGIN_TIME = 100;
//  private static final int PIDC_VAR_REP_WORK_TIME_1 = 10;
//  private static final int PIDC_VAR_REP_HEADER_INDEX_1 = 6;
//  private static final int PIDC_VAR_REP_HEADER_INDEX_2 = 11;
//  private static final int PIDC_VAR_HDR_SECOND_ROW_INDEX = 2;
//
//  private static final int PIDC_VAR_REP_WORK_TIME_2 = 30;
//  private static final int PIDC_VAR_REP_WORK_TIME_3 = 50;
//  private static final int PIDC_VAR_REP_WORK_TIME_4 = 90;
//
...
//  private static final int COL_NUM_5 = 5;
//
//  private static CellStyle shadedCellStyle;
//
//
//  /**
//   * Columns for PIDC variant attr compare sheet display
//   */
//  private final String[] pidcVarSheetHdr = new String[] {
...
//   */
//  public PIDCVariantCompareReport() {
//    super();
//  }
//
//  /**
...
//   */
//  public PIDCVariantCompareReport(final IProgressMonitor monitor) {
//    super();
...
//      this.monitor.beginTask("", PIDC_VAR_REP_BEGIN_TIME);
//      final PIDCVariant pidcVariant1 = (PIDCVariant) obj1;
//      final PIDCVariant pidcVariant2 = (PIDCVariant) obj2;
//      createPIDCCompareWorkSheet(pidcVariant1, pidcVariant2);
//    }
//
//  }
//
...
//   *
//   * @param pidcVariant1 {@link PIDCVersion} to compare
//   * @param pidcVariant2 {@link PIDCVersion} to compare
//   */
//  private void createPIDCCompareWorkSheet(final PIDCVariant pidcVariant1, final PIDCVariant pidcVariant2) {
//
//    this.monitor.worked(PIDC_VAR_REP_WORK_TIME_1);
//
//    // initialize sheet
//    final Sheet pidcAttrSheet = initializeWorksheet(pidcVariant1, pidcVariant2);
//
//    // create Compare Header Cell Style
//    PIDCVariantCompareReport.shadedCellStyle = createCompareHeaderCellStyle(this.workBook);
//
//    // construct First Header One card name is parsed since both variants belong to same card
//    final PIDCVersion pidcVer1 = pidcVariant1.getPidcVersion();
//    createCommonHeaderForCompare(this.workBook, pidcVer1.getName(), Long.toString(pidcVer1.getPidcRevision()),
//        pidcAttrSheet, PIDC_VAR_REP_HEADER_INDEX_1, 0);
//
//    // construct Second Header
//    createHeaderForCompare(this.workBook, pidcVariant1.getVariantName(), pidcVariant2.getVariantName(),
//        Long.toString(pidcVariant1.getRevision()), Long.toString(pidcVariant2.getRevision()), pidcAttrSheet,
//        PIDC_VAR_REP_HEADER_INDEX_1, PIDC_VAR_REP_HEADER_INDEX_2, 1);
//
//    // construct Third Header
//    final String[] sheetHeaders = this.pidcVarSheetHdr;
//    final Row headerSecondRow = ExcelUtil.getInstance().createExcelRow(pidcAttrSheet, PIDC_VAR_HDR_SECOND_ROW_INDEX);
...
//    this.monitor.worked(PIDC_VAR_REP_WORK_TIME_2);
//    final PidcVariantComparator pidcVarComparator = new PidcVariantComparator(pidcVariant1, pidcVariant2);
//    pidcVarComparator.compare();
//    this.monitor.worked(PIDC_VAR_REP_WORK_TIME_3);
//
//    pidcAttrSheet.setRowSumsBelow(false);
//    // populate data in sheet
//    final int rowCount = populateData(pidcVariant1, pidcAttrSheet, sheetHeaders, pidcVarComparator);
//    this.monitor.worked(PIDC_VAR_REP_WORK_TIME_4);
//    // set Sheet behavior
...
//   * @param pidcAttrSheet
//   * @param sheetHeaders
//   * @param pidcVarComparator
//   * @return
//   */
//  private int populateData(final PIDCVariant pidcVariant1, final Sheet pidcAttrSheet, final String[] sheetHeaders,
//      final PidcVariantComparator pidcVarComparator) {
//    final SortedSet<PidcVariantCompareResult> varCompResults = pidcVarComparator.getResult();
//    int rowCount = ROW_STARTING_COUNT;
//    for (PidcVariantCompareResult varCompResult : varCompResults) {
//      rowCount++;
//      constructRow(pidcAttrSheet, sheetHeaders, rowCount, varCompResult);
//      rowCount = populateChildRowsAndGroup(pidcVariant1, pidcAttrSheet, sheetHeaders, rowCount, varCompResult);
//    }
//    return rowCount;
//  }
//
...
//   * @param sheetHeaders
//   * @param rowCount
//   * @param pidcVarCompResult
//   * @return
//   */
//  private int populateChildRowsAndGroup(final PIDCVariant pidcVariant1, final Sheet pidcAttrSheet,
//      final String[] sheetHeaders, final int rCount, final PidcVariantCompareResult pidcVarCompResult) {
//    int rowCount = rCount;
//    final Map<PIDCVariant, Map<PIDCSubVariant, PidcCompareResult>> varSubVarMap =
//        pidcVarCompResult.getVariantSubVariantMap();
//    int compareRow = 0;
//    if ((varSubVarMap != null) && !varSubVarMap.isEmpty()) {
//      compareRow = rowCount + 1;
//      for (PIDCVariant pidcVariant : varSubVarMap.keySet()) {
//        final Map<PIDCSubVariant, PidcCompareResult> subVarCompResult = varSubVarMap.get(pidcVariant);
//        rowCount = createVarSubVarRows(pidcVariant1, pidcAttrSheet, sheetHeaders, pidcVarCompResult, rowCount,
//            pidcVariant, subVarCompResult);
//      }
//    }
//    // Group all variants for an attribute if subvariants are available for variants
//    if ((compareRow != 0) && (compareRow <= rowCount)) {
...
//   * @return
//   */
//  private int createVarSubVarRows(final PIDCVariant pidcVariant1, final Sheet pidcAttrSheet,
//      final String[] sheetHeaders, final PidcVariantCompareResult pidcVarCompResult, final int rCount,
//      final PIDCVariant pidcVariant, final Map<PIDCSubVariant, PidcCompareResult> subVarCompResult) {
//    int fromRow;
//    int rowCount = rCount;
...
//      PidcVariantCompareResult varCompResult;
//      varCompResult = new PidcVariantCompareResult();
//      varCompResult.setAttribute(pidcVarCompResult.getAttribute());
//      varCompResult.setFirstColumnSet(pidcVarCompResult.getFirstColumnSet());
//      varCompResult.setSecondColumnSet(pidcVarCompResult.getSecondColumnSet());
//      if (pidcVariant.getVariantName().equals(pidcVariant1.getVariantName())) {
//        final CompareColumns emptyColumn = new CompareColumns();
//        varCompResult.setSecondColumnSet(emptyColumn);
//      }
//      else {
//        final CompareColumns emptyColumn = new CompareColumns();
//        varCompResult.setFirstColumnSet(emptyColumn);
//      }
//
//      constructVarRow(pidcAttrSheet, sheetHeaders, rowCount, varCompResult, pidcVariant.getVariantName());
//      int mapSizeCount = 1;
...
//   * @return
//   */
//  private Sheet initializeWorksheet(final PIDCVariant pidcVariant1, final PIDCVariant pidcVariant2) {
//    final String sheetName = pidcVariant1.getVariantName().replaceAll("[^a-zA-Z0-9]+", "_") + " Vs " +
//        pidcVariant2.getVariantName().replaceAll("[^a-zA-Z0-9]+", "_");
...
//
//  /**
//   * Creates the compare row for the sheet
//   *
//   * @param workbook
//   * @param pidcAttrSheet
//   * @param sheetHeaders
...
//    fillColumnData(sheetHeaders, pidcVarCompResult, row);
//  }
//
//  /**
//   * Construct Variant row
//   *
//   * @param pidcAttrSheet
//   * @param sheetHeaders
//   * @param rowCount
...
//   * @param variantName
//   */
//  private void constructVarRow(final Sheet pidcAttrSheet, final String[] sheetHeaders, final int rowCount,
//      final PidcVariantCompareResult pidcVarCompResult, final String pidcVariantName) {
//    final Row row = ExcelUtil.getInstance().createExcelRow(pidcAttrSheet, rowCount);
//    fillVarColumnData(sheetHeaders, pidcVarCompResult, row, pidcVariantName);
//  }
//
//
//  /**
...
//    final Row row = ExcelUtil.getInstance().createExcelRow(pidcAttrSheet, rowCount);
//    fillSubVarColumnData(sheetHeaders, pidcCompareResult, row, subVariantName);
//  }
//
//  /**
//   * @param sheetHeaders
...
//   * @param pidcVariantName
//   */
//  private void fillVarColumnData(final String[] sheetHeaders, final PidcVariantCompareResult pidcVarCompResult,
//      final Row row, final String pidcVariantName) {
//    final Attribute attr = pidcVarCompResult.getAttribute();
//    final CompareColumns firstColumnSet = pidcVarCompResult.getFirstColumnSet();
//    final CompareColumns secondColumnSet = pidcVarCompResult.getSecondColumnSet();
//
...
//        fillValueColumn(pidcVarCompResult, row, firstColumnSet, secondColumnSet, col);
//      }
//      else if ((col < sheetHeaders.length) && sheetHeaders[col].equalsIgnoreCase(IExcelConstants.RH_USED)) {
//        fillUsedColumn(pidcVarCompResult, row, firstColumnSet, secondColumnSet, col);
//      }
//      else if ((col < sheetHeaders.length) && sheetHeaders[col].equalsIgnoreCase(IExcelConstants.RH_PART_NUMBER)) {
//        fillPartNumberColumn(pidcVarCompResult, row, firstColumnSet, secondColumnSet, col);
//      }
//      else if ((col < sheetHeaders.length) && sheetHeaders[col].equalsIgnoreCase(IExcelConstants.RH_SPEC_LINK)) {
//        fillSpecLinkColumn(pidcVarCompResult, row, firstColumnSet, secondColumnSet, col);
//      }
//      // ICDM-415
...
//        fillDescColumn(pidcVarCompResult, row, firstColumnSet, secondColumnSet, col);
//      }
...
//      }
//      else {
//        String result = colTxtFromAttr(col, attr, pidcVariantName, "");
//        CellStyle localCellStyle = this.cellStyle;
//        if (("").equals(result) && (col != COL_NUM_5)) {
//          localCellStyle = PIDCVariantCompareReport.shadedCellStyle;
//        }
...
//   * @param variant1Name
//   */
//  private void fillSubVarColumnData(final String[] sheetHeaders, final PidcCompareResult pidcCompareResult,
//      final Row row, final String subVariantName) {
...
//
//      if ((col < sheetHeaders.length) && sheetHeaders[col].equalsIgnoreCase(IExcelConstants.RH_VALUE)) {
//        fillSubVarValueColumn(row, firstColumnSet, secondColumnSet, col);
//      }
//      else if ((col < sheetHeaders.length) && sheetHeaders[col].equalsIgnoreCase(IExcelConstants.RH_USED)) {
//        fillSubVarUsedColumn(row, firstColumnSet, secondColumnSet, col);
//      }
//      else if ((col < sheetHeaders.length) && sheetHeaders[col].equalsIgnoreCase(IExcelConstants.RH_PART_NUMBER)) {
//        fillSubVarPartNumberColumn(row, firstColumnSet, secondColumnSet, col);
//      }
//      else if ((col < sheetHeaders.length) && sheetHeaders[col].equalsIgnoreCase(IExcelConstants.RH_SPEC_LINK)) {
//        fillSubVarSpecLinkColumn(row, firstColumnSet, secondColumnSet, col);
//      }
//      else if (((col == IExcelConstants.COLUMN_NUM_TEN) || (col == IExcelConstants.COLUMN_NUM_FIFTEEN)) &&
//          sheetHeaders[col].equalsIgnoreCase(IExcelConstants.RH_ADDITIONAL_INFO_DESC)) {
//        fillSubVarDescColumn(row, firstColumnSet, secondColumnSet, col);
//      }
//      else if (col == sheetHeaders.length) {
//        // create invisible cell indicating attribute ID
//        ExcelUtil.getInstance().createCell(row, String.valueOf(attr.getAttributeID()), col, this.cellStyle);
//      }
//      else {
//        String result = colTxtFromAttr(col, attr, "", subVariantName);
//        CellStyle localCellStyle = this.cellStyle;
//        if ("".equals(result) && (col != COL_NUM_5)) {
//          localCellStyle = PIDCVariantCompareReport.shadedCellStyle;
//        }
...
//   * @param variant1Name
//   */
//  private void fillColumnData(final String[] sheetHeaders, final PidcVariantCompareResult pidcVarCompResult,
//      final Row row) {
//    final Attribute attr = pidcVarCompResult.getAttribute();
//    final CompareColumns firstColumnSet = pidcVarCompResult.getFirstColumnSet();
//    final CompareColumns secondColumnSet = pidcVarCompResult.getSecondColumnSet();
...
//      else {
//        String result;
//        if (isDiffEnabled(pidcVarCompResult, firstColumnSet, secondColumnSet, col)) {
...
//   * @return
//   */
//  private boolean isDiffEnabled(final PidcVariantCompareResult pidcVarCompResult, final CompareColumns firstColumnSet,
//      final CompareColumns secondColumnSet, final int col) {
//    return (col == IExcelConstants.COLUMN_NUM_SIXTEEN) &&
//        (pidcVarCompResult.isDiff() || areBothSubVariants(firstColumnSet, secondColumnSet));
//  }
//
//
//  /**
...
//   * @param col
//   */
//  private void fillSubVarUsedColumn(final Row row, final CompareColumns firstColumnSet,
//      final CompareColumns secondColumnSet, final int col) {
...
//   * @param col
//   */
//  private void fillSubVarPartNumberColumn(final Row row, final CompareColumns firstColumnSet,
//
//      final CompareColumns secondColumnSet, final int col) {
//    String result = IExcelConstants.EMPTY_STRING;
//    CellStyle localCellStyle = this.cellStyle;
...
//   * @param col
//   */
//  private void fillSubVarSpecLinkColumn(final Row row, final CompareColumns firstColumnSet,
//
//      final CompareColumns secondColumnSet, final int col) {
//    String result = IExcelConstants.EMPTY_STRING;
//    CellStyle localCellStyle = this.cellStyle;
...
//    }
//
//    ExcelUtil.getInstance().createHyperLinkCell(this.workBook, row, result, col, localCellStyle, false);
//
//  }
//
//  /**
...
//   * @param col
//   */
//  private void fillSubVarDescColumn(final Row row, final CompareColumns firstColumnSet,
//
//      final CompareColumns secondColumnSet, final int col) {
//    String result = IExcelConstants.EMPTY_STRING;
//    CellStyle localCellStyle = this.cellStyle;
...
//   * @param col
//   */
//  private void fillUsedColumn(final PidcVariantCompareResult pidcVarCompResult, final Row row,
...
//    }
//    CellStyle localCellStyle = this.cellStyle;
//    if (pidcVarCompResult.isAttrUsedFlagDiff() &&
//        !usedValue.equals(ApicConstants.PROJ_ATTR_USED_FLAG.NOT_DEFINED.getUiType())) {
//      if ((col == IExcelConstants.COLUMN_NUM_SIX) &&
//          (secondColumnSet.getUsedFlag().equals(ApicConstants.USED_NOTDEF_DISPLAY))) {
...
//   * @param col
//   */
//  private void fillValueColumn(final PidcVariantCompareResult pidcVarCompResult, final Row row,
//      final CompareColumns firstColumnSet, final CompareColumns secondColumnSet, final int col) {
//    String result = IExcelConstants.EMPTY_STRING;
//    if (col == IExcelConstants.COLUMN_NUM_SEVEN) {
//      result = firstColumnSet.getAttrValue();
...
//      result = secondColumnSet.getAttrValue();
//    }
//    final boolean isRed = isRedFontEnabled(pidcVarCompResult, firstColumnSet, secondColumnSet, col, result,
...
//   * @param col
//   */
//  private void fillPartNumberColumn(final PidcVariantCompareResult pidcVarCompResult, final Row row,
//      final CompareColumns firstColumnSet, final CompareColumns secondColumnSet, final int col) {
//    String result = IExcelConstants.EMPTY_STRING;
//    if (col == IExcelConstants.COLUMN_NUM_EIGHT) {
//      result = firstColumnSet.getPartNumber();
...
//   * @param col
//   */
//  private void fillSpecLinkColumn(final PidcVariantCompareResult pidcVarCompResult, final Row row,
//      final CompareColumns firstColumnSet, final CompareColumns secondColumnSet, final int col) {
//    String result = IExcelConstants.EMPTY_STRING;
//    if (col == IExcelConstants.COLUMN_NUM_NINE) {
//      result = firstColumnSet.getSpecLink();
...
//   * @param col
//   */
//  private void fillDescColumn(final PidcVariantCompareResult pidcVarCompResult, final Row row,
//      final CompareColumns firstColumnSet, final CompareColumns secondColumnSet, final int col) {
//    String result = IExcelConstants.EMPTY_STRING;
//    if (col == IExcelConstants.COLUMN_NUM_TEN) {
//      result = firstColumnSet.getDesc();
...
//   * @return
//   */
//  private boolean isRedFontEnabled(final PidcVariantCompareResult pidcVarCompResult,
...
//        pidcVarCompResult.isAttrValueDiff() && (result != null) && !result.trim().isEmpty()) {
...
//        pidcVarCompResult.isPartNumberDiff() && (result != null) && !result.trim().isEmpty()) {
...
//        pidcVarCompResult.isSpecLinkDiff() && (result != null) && !result.trim().isEmpty()) {
...
//        pidcVarCompResult.isDescDiff() && (result != null) && !result.trim().isEmpty()) {
//      if (((col == index1) && isSecondColDescValid(secondColumnSet)) || (col == index2)) {
//        isRed = true;
//      }
//
//    }
//    // When both are subvariants both cells are shown in red color
//    if (areBothSubVariants(firstColumnSet, secondColumnSet)) {
//      isRed = true;
//    }
//    return isRed;
//  }
